...
function pickOwner(it) {
  return it?.ownerEmail || it?.ownerUsername || it?.ownerUserId || "â€”";
}
        ...
        >
          <label style={{ display: "grid", gap: "0.25rem" }}>
            ...
            <input
              ...
              placeholder="title, filename, owner, id, hashâ€¦"
          ...
          <label style={{ display: "grid", gap: "0.25rem" }}>
            ...
            >
              ...
              <option value="STATUS_ASC">Status (A â†’ Z)</option>
            </select>
          </label>
            ...
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: 0 }}>
              ...
              <tbody>
                {filteredSorted.map((it) => {
                  ...
                  const ownerShort = ownerFull === "â€”" ? "â€”" : truncateMiddle(ownerFull, 30);
                  const idFull = it.documentId;
                  const idShort = idFull ? truncateMiddle(idFull, 26) : "â€”";
